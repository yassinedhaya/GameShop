...
class ListViewPageWidget extends StatefulWidget {
  ...
  static String routeName = 'ListViewPage';
  static String routePath = '/listViewPage';
...
class _ListViewPageWidgetState extends State<ListViewPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListViewPageModel());
  }
